    ...
    <Container maxW={"7xl"}>
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            Piggy Bank is a online banking system that allows you to manage your
            money and transactions easily and securely.
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
        ...
        >
          <Blob
            ...
            left={0}
            zIndex={-1}
            color={useColorModeValue("blackAlpha.100", "red.400")}
          />
          <Box
            position={"relative"}
            height={"300px"}
